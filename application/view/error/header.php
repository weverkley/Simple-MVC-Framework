...
<html lang="en">
  <head>
    ...
    <link href="<?= BASE_URL ?>public/css/bootstrap-flat.min.css" rel="stylesheet">
    <link href="<?= BASE_URL ?>public/css/bootstrap-flat-extras.min.css" rel="stylesheet">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <?php 
                        ...
                        $pages["index"] = "Home";
                        /*
                        * if HIDE_DEFAULT_CONTROLLER is set to true you dont have to set
                        * the controler before your action.
                        * Ex: $pages["about"] = "About";
                        */
